...
int main(void)
{
	...
	handlerLED_1.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
	...
	handlerLED_2.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
	...
	handlerLED_3.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
	...
	handlerLED_4.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
	...
	handlerLED_5.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
	...
	handlerLED_6.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
	...
	handlerLED_7.GPIO_PinConfig.GPIO_PinMode				= GPIO_MODE_IN;
