...
void USART_Config(USART_Handler_t *ptrUsartHandler){
	...
	/*
	 * Definimos los baud rate para 80MHz
	 */

	else if(ptrUsartHandler->USART_Config.USART_baudrate == USART_BAUDRATE_80MHz_19200){
		// Escriba acá su código y los comentarios que faltan
		// El valor a cargar es 260.41667 -> Mantiza = 260,fraction = 0.41667
		// Mantiza = 260 = 0x208, fraction = 16 * 0.41667 = 7
		// Valor a cargar 0x1047
		ptrUsartHandler->ptrUSARTx->BRR = 0x01047;
	}
	...
	//Configuracion del USART a 100MHz
